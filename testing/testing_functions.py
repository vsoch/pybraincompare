...
def run_scatterplot_compare_resample(voxdim):
  ...
  images, ref_4mm = resample_images_ref(images,image1,interpolation="continuous",resample_dim=voxdim)
...
def run_scatterplot_compare(images,atlas_file,atlas_xml):
